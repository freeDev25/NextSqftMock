...
$config3 = array(
    'id' => 'page_leads_meta_box', // meta box id, unique per meta box
    'title' => 'Leads Options', // meta box title
    'pages' => array('leads'), // post types, accept custom post types as well, default is array('post'); optional
...
$page_bottom->addText($prefix . 'name', array('name' => 'Name'));
$page_bottom->addText($prefix . 'email', array('name' => 'Email'));
$page_bottom->addText($prefix . 'phone', array('name' => 'Phone'));
$page_bottom->addText($prefix . 'local_location', array('name' => 'Location'));
...
$page_bottom->addText($prefix . 'bedrooms', array('name' => 'Bedrooms'));
$page_bottom->addText($prefix . 'bathrooms', array('name' => 'Bathrooms'));
$page_bottom->addText($prefix . 'facing', array('name' => 'Facing'));
$page_bottom->addText($prefix . 'status', array('name' => 'Status'));
$page_bottom->addText($prefix . 'floor_no', array('name' => 'Floor no'));
