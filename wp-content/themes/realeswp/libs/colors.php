...
$prop_featured_badge_bg  = isset($reales_colors_settings['reales_prop_featured_badge_bg_field']) ? $reales_colors_settings['reales_prop_featured_badge_bg_field'] : '';
$fav_icon                = isset($reales_colors_settings['reales_fav_icon_color_field']) ? $reales_colors_settings['reales_fav_icon_color_field'] : '';
$map_marker              = isset($reales_colors_settings['reales_marker_color_field']) ? $reales_colors_settings['reales_marker_color_field'] : '';
...
if($main_color != '') {
    print '
        ...
        .price-marker:after {
            ...
            border-right:1px solid ' . esc_html($main_color) . ' !important;
            border-bottom:1px solid ' . esc_html($main_color) . ' !important;
        }
...
if($prop_featured_badge_bg != '') {
    print '
        .propWidget-2 .fig .featured-label .featured-label-content, 
        .propWidget-2-2 .featured-label .featured-label-content {
            background-color: ' . esc_html($prop_featured_badge_bg) . ' !important;
        }
        .propWidget-2 .fig .featured-label .featured-label-left, 
        .propWidget-2-2 .featured-label .featured-label-left {
            border-color: transparent transparent ' . esc_html($prop_featured_badge_bg) . ' transparent !important;
        }
        .propWidget-2 .fig .featured-label .featured-label-right, 
        .propWidget-2-2 .featured-label .featured-label-right {
            border-color: transparent transparent transparent ' . esc_html($prop_featured_badge_bg) . ' !important;
        }
...
if($map_marker != '') {
    print '
        .price-marker {
            color: ' . esc_html($map_marker) . ' !important;
            border: 1px solid ' . esc_html($map_marker) . ' !important;
            background-color: #fff !important;
        }
        .price-marker:after {
            background: #fff !important;
            border-right:1px solid ' . esc_html($map_marker) . ' !important;
            border-bottom:1px solid ' . esc_html($map_marker) . ' !important;
        }
        .no-touch .price-marker:hover,
        .price-marker.active {
            color: #fff !important;
            background-color: ' . esc_html($map_marker) . ' !important;
        }
        .no-touch .price-marker:hover:after,
        .price-marker.active:after {
            color: #fff !important;
