...
<html <?php language_attributes(); ?>>
    ...
    <script data-ad-client="ca-pub-9455695499020495" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
    <!-- Google Tag Manager -->
    <script>(function (w, d, s, l, i) {
        ...
        })(window, document, 'script', 'dataLayer', 'GTM-MHDF2V4');</script>
...
<body <?php body_class($body_classes); ?>>
    ...
    } else if (is_single() && is_singular('leads')) {
        get_template_part('templates/post_leads');
    } else if (!(is_page_template('property-search-results.php') || is_page_template('property-search-results-seo.php')) &&
