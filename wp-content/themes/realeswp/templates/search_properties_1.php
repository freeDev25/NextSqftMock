...
<style>
    ...
    .search-panel.contact-search-panel.search-panel-d2, 
    .search-panel.contact-search-panel.search-panel-d3 {
        position: static;
        background: #fff;
        padding: 0;
        transform: none;
    ...
    .contact-search-panel .search-panel-fields {
        display: flex;
        flex-wrap: wrap;
    }
    .contact-search-panel .form-group {
        flex-basis: 50%;
    ...
    .contact-search-panel .btn.btn-white.dropdown-toggle {
        border: 1px solid #e8e8e8;
    }

</style>

<div class="search-panel contact-search-panel <?php echo esc_attr($design_class); ?>">

<!--        <form class="form-inline" id="searchPropertyForm2" role="search" method="get" action="<?php echo esc_url($search_submit); ?>">-->
    ...
    <div class="search-panel-fields">
        ...
        <?php } ?>
        <?php
        if ($s_city_field != '' && $s_city_field == 'enabled') {
