    ...
    <div class="page-content">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9">
                ...
                <h2 class="pageHeader"><?php printf( __( 'Search Results for: %s', 'realeswp' ), '<span>' . esc_html(get_search_query()) . '</span>' ); ?></h2>
                    <?php 
                    ...
                    <?php else : 
                        esc_html_e('Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'realeswp');
                    endif;
                    wp_reset_postdata();
                    ?>
