                ...
                <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                    ...
                    <div class="row pb20">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <h4><?php esc_html_e('Contact Details', 'realeswp'); ?></h4>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                            <?php if(($c_facebook && $c_facebook != '') || ($c_twitter && $c_twitter != '') || ($c_google && $c_google != '') || ($c_linkedin && $c_linkedin != '')) { ?>
                                <h4><?php esc_html_e('Follow Us', 'realeswp'); ?></h4>
                    ...
                    <h4><?php esc_html_e('Send Us a Message', 'realeswp'); ?></h4>
                    <form class="contactPageForm">
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label for="cp_name"><?php esc_html_e('Name', 'realeswp'); ?> <span class="text-red">*</span></label>
                                    <input type="text" id="cp_name" name="cp_name" placeholder="<?php esc_html_e('Enter your name', 'realeswp'); ?>" class="form-control">
                                </div>
                             </div>
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="form-group">
                                    <label for="cp_email"><?php esc_html_e('Email', 'realeswp'); ?> <span class="text-red">*</span></label>
                                    <input type="text" id="cp_email" name="cp_email" placeholder="<?php esc_html_e('Enter your email', 'realeswp'); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="cp_subject"><?php esc_html_e('Subject', 'realeswp'); ?> <span class="text-red">*</span></label>
                                    <input type="text" id="cp_subject" name="cp_subject" placeholder="<?php esc_html_e('Enter the subject', 'realeswp'); ?>" class="form-control">
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <label for="cp_message"><?php esc_html_e('Message', 'realeswp'); ?> <span class="text-red">*</span></label>
                                    <textarea id="cp_message" name="cp_message" placeholder="<?php esc_html_e('Type your message', 'realeswp'); ?>" rows="3" class="form-control"></textarea>
                                </div>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group">
                                    <a href="javascript:void(0);" class="btn btn-green" id="sendContactMessageBtn"><?php esc_html_e('Send Message', 'realeswp'); ?></a>
                                </div>
                            </div>
                        </div>
