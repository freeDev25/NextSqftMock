...
class Drafts_List_Table extends \WP_List_Table {
    ...
    protected function get_posts_object() {
        ...
        $Linked_lead_id = filter_input(INPUT_GET, 'pid', FILTER_VALIDATE_INT);
    ...
    public function column_default($item, $column_name) {
        $result = '';
        $saller_name = get_post_meta($item['id'], METABOX_PREFIX . 'name', true);
        $saller_phone = get_post_meta($item['id'], METABOX_PREFIX . 'phone', true);
        $saller_email = get_post_meta($item['id'], METABOX_PREFIX . 'email', true);


        $bedroom = get_post_meta($item['id'], METABOX_PREFIX . 'bedroom', true);
        $bathroom = get_post_meta($item['id'], METABOX_PREFIX . 'bathroom', true);
        $floor = get_post_meta($item['id'], METABOX_PREFIX . 'floor', true);
        $size = get_post_meta($item['id'], METABOX_PREFIX . 'size', true);
        $price = get_post_meta($item['id'], METABOX_PREFIX . 'price', true);
        switch ($column_name) {
            case 'date':
    ...
    public function get_columns() {
        return array(
            ...
            'name' => __('Name', 'admin-table-tut'),
            'phone' => __('Phone', 'admin-table-tut'),
            'email' => __('Email', 'admin-table-tut'),
            'bedroom' => __('Bedroom', 'admin-table-tut'),
            'bathroom' => __('Bathroom', 'admin-table-tut'),
            'floor' => __('Floor', 'admin-table-tut'),
            'size' => __('Size', 'admin-table-tut'),
            'price' => __('Price', 'admin-table-tut'),
