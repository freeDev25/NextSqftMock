                ...
                <?php while(have_posts()) : the_post(); 
                        ...
                        <div class="post-share">
                            <div class="ps-social">
                                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>"
                                    ...
                                    target="_blank" title="<?php esc_html_e('Share on Facebook', 'realeswp'); ?>" class="btn btn-sm btn-icon btn-round btn-o btn-facebook">
                                    <span class="fa fa-facebook"></span>
                                </a>
                                <a href="https://twitter.com/share?url=<?php the_permalink(); ?>&amp;text=<?php echo urlencode(get_the_title()); ?>"
                                    onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;"
                                    target="_blank" title="<?php esc_html_e('Share on Twitter', 'realeswp'); ?>" class="btn btn-sm btn-icon btn-round btn-o btn-twitter">
                                    <span class="fa fa-twitter"></span>
                                </a>
                                <a href="http://www.linkedin.com/shareArticle?mini=true&url=<?php the_permalink(); ?>&title=<?php echo urlencode(get_the_title()); ?>" 
                                    target="_blank" title="<?php esc_html_e('Share on LinkedIn', 'realeswp'); ?>" class="btn btn-sm btn-icon btn-round btn-o btn-linkedin">
                    ...
                    <div class="f-pn-articles">
                        <a href="<?php if (!empty( $prev_post )): echo esc_url(get_permalink( $prev_post->ID )); endif; ?>" class="f-p-article">
                            ...
                            <div class="fpna-title"><?php esc_html_e('Previous article', 'realeswp') ?></div>
                        ...
                        <a href="<?php if (!empty( $next_post )): echo esc_url(get_permalink( $next_post->ID )); endif; ?>" class="f-n-article">
                            ...
                            <div class="fpna-title"><?php esc_html_e('Next article', 'realeswp') ?></div>
                    ...
                    <?php the_tags('<div class="single-post-tags"><span>' . __('Tags', 'realeswp') . ': </span><ul><li>', '</li><li>', '</li></ul></div>'); ?>
