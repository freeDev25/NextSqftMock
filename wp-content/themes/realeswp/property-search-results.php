    ...
    <?php } ?>
        ...
        <div class="resultsList">
                        ...
                        <div class="sorter-wrapper pb10">
                            <div class="form-group">
                                ...
                                <ul class="dropdown-menu dropdown-select sorter">
                                    ...
                                    ?>
                                    <li class="active"><input type="radio" name="sort" value="newest" <?php if(!$sort || $sort == '' || $sort == 'newest') { echo 'checked="checked"'; } ?> ><a href="javascript:void(0);"><?php esc_html_e('Newest', 'realeswp'); ?></a></li>
                                    <?php if($p_price != '' && $p_price == 'enabled') { ?>
                                        <li><input type="radio" name="sort" value="price_lo" <?php if($sort && $sort != '' && $sort == 'price_lo') { echo 'checked="checked"'; } ?> ><a href="javascript:void(0);"><?php esc_html_e('Price (Lo-Hi)', 'realeswp'); ?></a></li>
                                        <li><input type="radio" name="sort" value="price_hi" <?php if($sort && $sort != '' && $sort == 'price_hi') { echo 'checked="checked"'; } ?> ><a href="javascript:void(0);"><?php esc_html_e('Price (Hi-Lo)', 'realeswp'); ?></a></li>
                                    <?php } ?>
                                    <?php if($p_bedrooms != '' && $p_bedrooms == 'enabled') { ?>
                                        <li><input type="radio" name="sort" value="bedrooms" <?php if($sort && $sort != '' && $sort == 'bedrooms') { echo 'checked="checked"'; } ?> ><a href="javascript:void(0);"><?php esc_html_e('Bedrooms', 'realeswp'); ?></a></li>
                                    <?php } ?>
                                    <?php if($p_bathrooms != '' && $p_bathrooms == 'enabled') { ?>
                                        <li><input type="radio" name="sort" value="bathrooms" <?php if($sort && $sort != '' && $sort == 'bathrooms') { echo 'checked="checked"'; } ?> ><a href="javascript:void(0);"><?php esc_html_e('Bathrooms', 'realeswp'); ?></a></li>
                                    <?php } ?>
                                    <?php if($p_area != '' && $p_area == 'enabled') { ?>
                                        <li><input type="radio" name="sort" value="area" <?php if($sort && $sort != '' && $sort == 'area') { echo 'checked="checked"'; } ?> ><a href="javascript:void(0);"><?php esc_html_e('Area', 'realeswp'); ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
            ...
            if($searched_posts->have_posts()) {
                        ...
                        <?php if($card_type == 'd2') { ?>
                            <a href="<?php echo esc_url(get_permalink($prop_id)); ?>" class="card-2" id="card-<?php echo esc_attr($prop_id); ?>" data-prop="<?php echo esc_attr($prop_id); ?>">
								...
								<?php if(is_user_logged_in()) {
                                        ...
                                        <?php } else { ?>
                                            <a data-toggle="modal" href="#contactAgent" data-agent-id="<?php echo $agent_id ?>" data-post-id="<?php echo get_the_ID(); ?>" class="btn btn-green contactBtn"><?php esc_html_e('Contact Seller', 'realeswp'); ?></a>
                                    <?php } } else { ?>
                                        <a data-toggle="modal" href="#contactAgent" data-agent-id="<?php echo $agent_id ?>" data-post-id="<?php echo get_the_ID(); ?>" class="btn btn-green contactBtn"><?php esc_html_e('Contact Seller', 'realeswp'); ?></a>
                                    <?php } ?>
                            </a>
                ...
                <div style="height: 300px; text-align: center;"><h1>
					Sorry for the inconvenience
					</h1><?php echo do_shortcode('[popup_anything id="1090"]'); ?></div>
            <?php } ?>
            </div>
            <div class="pull-left">
...
<div class="modal fade" id="contactAgent" role="dialog" aria-labelledby="contactLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<?php echo do_shortcode( '[contact-form-7 id="1451" title="Contact Form for Seller"]' ); ?>
